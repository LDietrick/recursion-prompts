...
var arraySum = function(array) {
  if (array.length === 0) {
    ...
    // if current element is an array, then call function on that element
    if (Array.isArray(currentElement)) {
      currentElement = arraySum(currentElement);
    }
    // sum is value of current element plus the sum of remaining ones
    var result = currentElement + arraySum(array.slice(1));
    return result;
  }
};
